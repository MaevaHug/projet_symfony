 ...
 */
class getRecipeLikeRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecipeLikeRepository.php';

        return $container->privates['App\\Repository\\RecipeLikeRepository'] = new \App\Repository\RecipeLikeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
