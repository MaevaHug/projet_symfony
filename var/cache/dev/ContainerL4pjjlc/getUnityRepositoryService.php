 ...
 */
class getUnityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UnityRepository' shared autowired service.
     *
     * @return \App\Repository\UnityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UnityRepository.php';

        return $container->privates['App\\Repository\\UnityRepository'] = new \App\Repository\UnityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
