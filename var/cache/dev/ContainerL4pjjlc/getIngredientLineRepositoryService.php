 ...
 */
class getIngredientLineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IngredientLineRepository' shared autowired service.
     *
     * @return \App\Repository\IngredientLineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IngredientLineRepository.php';

        return $container->privates['App\\Repository\\IngredientLineRepository'] = new \App\Repository\IngredientLineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
