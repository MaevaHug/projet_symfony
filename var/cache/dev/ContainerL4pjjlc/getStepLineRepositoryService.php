 ...
 */
class getStepLineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StepLineRepository' shared autowired service.
     *
     * @return \App\Repository\StepLineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StepLineRepository.php';

        return $container->privates['App\\Repository\\StepLineRepository'] = new \App\Repository\StepLineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
